...
//      __host__ __device__ Map(pKeyCmp, pValCmp);
...
//
//   template<typename K, typename V>
//   __host__ __device__ Map<K, V>::Map(Map<K, V>::pKeyCmp kcmp, Map<K, V>::pValCmp vcmp) : kcmp(kcmp), vcmp(vcmp)
//   {
...
//
//      for (int k = 0; k < NUM_BUCKETS; ++k) {
//         res += LinkedListKV::HashCode(buckets[k], Hasher::Hash);
//      }
//
//      return res;
//   }
