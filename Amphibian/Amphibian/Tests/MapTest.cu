...
//      unsigned int tmp2 = 1;
//      h2 = Hasher::Hash((char*)&tmp2, sizeof(unsigned int));
//      if (h1 != h2) {
...
//   {
//      Map::Map<String::String, double> map(String::AreEqual, [](double& a, double& b) {return a == b; });
...
//   {
//      Map::Map<String::String, double> m1(String::AreEqual, [](double& a, double& b) { return a == b; });
...
//      //printf("\n");
//
//      Map::Map<String::String, double> map4(String::AreEqual, [](double& a, double& b) { return a == b; });
...
//      auto h1 = m1.Hash((char*)&tmp1, sizeof(unsigned int));
//      unsigned int tmp2 = 1;
//      auto h2 = Hasher::Hash((char*)&tmp2, sizeof(unsigned int));
//      if (h1 != h2) {
//         printf("value: (%d, %u), (%d, %u)\n", tmp1, h1, tmp2, h2);
//      }
//
...
//   {
//   public:
//      __device__ TestClass() : m(String::AreEqual, doubleCmp) {}
//
//      //__device__ Map::Map<String::String, double>GetMap() { return m; }
//
...
//   {
//      Map::Map<String::String, TestClass> m1(String::AreEqual, AreEqualTestClass);
//      TestClass a;
//      TestClass b;
//
//      unsigned int tmp1 = 1;
