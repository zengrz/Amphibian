...
namespace LinkedListTest
{
   ...
   //    LinkedList::AddAllAsSet<LinkedListTestType>(&head, alist, AreEqual);
   //    //PrintList(head);
   //    LinkedList::AddAllAsSet<LinkedListTestType>(&head, blist, AreEqual);
   //    //PrintList(head);
   //    LinkedList::AddAllAsSet<LinkedListTestType>(&head, clist, AreEqual);
   //    //PrintList(head);
